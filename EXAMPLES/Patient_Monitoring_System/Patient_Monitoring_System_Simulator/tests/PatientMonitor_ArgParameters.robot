...
Library       Remote    http://${RemoteServerIP}:${RemoteServerPORT}
...
*** Test Cases ***
TC_VERIFY_BLOOD_PRESSURE_ARG_PARAM
...
*** Test Cases *** 
TC_VERIFY_TEMPERATURE_ARG_PARAM
...
*** Test Cases ***
TC_CHECK_SCHEDULE_DOSE_ARG_PARAM
